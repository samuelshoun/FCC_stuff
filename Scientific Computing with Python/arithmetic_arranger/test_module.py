'''
This script ('test_module.py') is copied from the forked repl.it project
at https://replit.com/github/freeCodeCamp/boilerplate-arithmetic-formatter.
It is intended to be called by 'main.py' to test the function I created in
